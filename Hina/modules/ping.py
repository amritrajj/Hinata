...
from Hina.config import StartTime, app
...
@sudo_plus
def ping(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
@sudo_plus
def pingall(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
app.add_handler(PINGALL_HANDLER)
