...
from Hina.modules.helper_funcs.extraction import extract_user_and_text
...
@bot_admin
def rban(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
@bot_admin
def runban(update: Update, context: ContextTypes.DEFAULT_TYPE):
    bot, args = context.bot, context.args
    message = update.effective_message
...
@bot_admin
def rkick(update: Update, context: ContextTypes.DEFAULT_TYPE):
    bot, args = context.bot, context.args
    message = update.effective_message
...
@bot_admin
def rmute(update: Update, context: ContextTypes.DEFAULT_TYPE):
    bot, args = context.bot, context.args
    message = update.effective_message
...
@bot_admin
def runmute(update: Update, context: ContextTypes.DEFAULT_TYPE):
    bot, args = context.bot, context.args
    message = update.effective_message
...
app.add_handler(RBAN_HANDLER)
app.add_handler(RUNBAN_HANDLER)
app.add_handler(RKICK_HANDLER)
app.add_handler(RMUTE_HANDLER)
app.add_handler(RUNMUTE_HANDLER)
