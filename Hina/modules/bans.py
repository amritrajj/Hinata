...
from Hina.modules.log_channel import gloggable, loggable
...
@user_can_ban
@loggable
def unban(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    message = update.effective_message
    user = update.effective_user
    chat = update.effective_chat
    log_message = ""
...
@can_restrict
@gloggable
def selfunban(context: ContextTypes.DEFAULT_TYPE, update: Update) -> str:
    message = update.effective_message
    user = update.effective_user
    bot, args = context.bot, context.args
...
PUNCHME_HANDLER = DisableAbleCommandHandler("punchme", punchme, filters=filters.ChatType.GROUPS)

app.add_handler(BAN_HANDLER)
app.add_handler(TEMPBAN_HANDLER)
app.add_handler(PUNCH_HANDLER)
app.add_handler(UNBAN_HANDLER)
app.add_handler(ROAR_HANDLER)
app.add_handler(PUNCHME_HANDLER)
