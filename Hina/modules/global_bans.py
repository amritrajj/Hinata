...
from telegram.constants import ParseMode
from telegram.error import BadRequest, TelegramError, TelegramError
...
import Hina.modules.sql.global_bans_sql as sql
...
from Hina.modules.helper_funcs.misc import send_to_list
...
app.add_handler(GBAN_HANDLER)
app.add_handler(UNGBAN_HANDLER)
app.add_handler(GBAN_LIST)
app.add_handler(GBAN_STATUS)

__mod_name__ = "Anti-Spam"
__handlers__ = [GBAN_HANDLER, UNGBAN_HANDLER, GBAN_LIST, GBAN_STATUS]

if STRICT_GBAN:  # enforce GBANS if this is set
    app.add_handler(GBAN_ENFORCER, GBAN_ENFORCE_GROUP)
