...
app.add_handler(CHARACTER_HANDLER)
app.add_handler(MANGA_HANDLER)
app.add_handler(AIRING_HANDLER)
app.add_handler(USER_HANDLER)
app.add_handler(KAIZOKU_SEARCH_HANDLER)
app.add_handler(KAYO_SEARCH_HANDLER)
