...
import Hina.modules.fun_strings as fun_strings
...
app.add_handler(WEEBIFY_HANDLER)
app.add_handler(SHOUT_HANDLER)
app.add_handler(SANITIZE_HANDLER)
app.add_handler(RUNS_HANDLER)
app.add_handler(SLAP_HANDLER)
app.add_handler(PAT_HANDLER)
app.add_handler(ROLL_HANDLER)
app.add_handler(TOSS_HANDLER)
app.add_handler(SHRUG_HANDLER)
app.add_handler(BLUETEXT_HANDLER)
app.add_handler(RLG_HANDLER)
app.add_handler(DECIDE_HANDLER)
app.add_handler(EIGHTBALL_HANDLER)
app.add_handler(TABLE_HANDLER)
