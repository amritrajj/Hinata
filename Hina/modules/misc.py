...
MARKDOWN_HELP = f"""
Markdown is a very powerful formatting tool supported by Telegram.<b>{{bot_name}}</b> has some enhancements, to make sure that \
...
async def echo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if len(args) < 2:
        await message.reply_text("Usage: /echo <message>")
        return
...
app.add_handler(MD_HELP_HANDLER)
